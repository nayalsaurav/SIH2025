...
import type { QualityTest } from "../../../../context/BlockchainContext";
...
const QualityMetrics: React.FC<QualityMetricsProps> = ({ qualityTests }) => {
  ...
  if (!averages)
    return <p className="text-gray-500">No quality test data available</p>;
      ...
      <div className="bg-white dark:bg-zinc-800 rounded-xl p-6 shadow-lg">
        <div className="flex items-center mb-4">
          ...
          <div>
            ...
            <p
              className={`text-2xl font-bold ${getStatusColor(stats.moisture, 10)}`}
            >
      ...
      <div className="bg-white dark:bg-zinc-800 rounded-xl p-6 shadow-lg">
        <div className="flex items-center mb-4">
          ...
          <div>
            ...
            <p
              className={`text-2xl font-bold ${getStatusColor(stats.dnaAuthenticityRate, 95)}`}
            >
